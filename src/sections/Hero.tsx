...
export default function Hero() {
    ...
    useEffect(() => {
        ...
        return () => {
            leftPointerScope.current && leftPointerAnimate(leftPointerScope.current, { opacity: 0 });
            rightPointerScope.current && rightPointerAnimate(rightPointerScope.current, { opacity: 0 });
        };
